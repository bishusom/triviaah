// lib/brainwave/foodle/foodle-logic.ts
import { FoodPuzzle } from '@/lib/brainwave/foodle/foodle-sb';

export interface FoodGuessResult {
  guess: string;
  isCorrect: boolean;
...
// Enhanced normalization function for food names
...
export function checkFoodGuess(
  guess: string, 
  puzzle: FoodPuzzle
): FoodGuessResult {
