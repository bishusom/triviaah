...
import { 
  ...
  UserDISCAnswer,
  DISCBehavior
} from '@/lib/iq-and-personality-tests/disc/disc-types';
import { 
  discQuestions,
  calculateNaturalAndAdaptedScores,
  getDISCResult
} from '@/lib/iq-and-personality-tests/disc/disc-logic';
...
Share your results:
https://elitetrivias.com/brainwave/disc
...
Discover your DISC profile at https://elitetrivias.com/brainwave/disc`;
  };
