...
import { 
  ...
  TraitPercentiles,
  UserAnswer 
} from '@/lib/iq-and-personality-tests/big-five/trait-types';
import { 
  traitQuestions,
  calculateTraitScores,
  getTraitResult
} from '@/lib/iq-and-personality-tests/big-five/trait-logic';
...
Share your results:
https://elitetrivias.com/brainwave/big-five
...
Discover your personality type at https://elitetrivias.com/brainwave/big-five`;
  };
