...
import { Home, Brain, Leaf, Target, Zap, Eye, EyeOff, Search, Sparkles, ThermometerSun, Droplets, Ruler, Flower } from 'lucide-react';
      ...
      <div className="bg-gray-800/50 backdrop-blur-lg rounded-3xl border border-gray-700 p-5 mb-5">
        ...
        <div className="flex justify-between items-center mb-5">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-white">Guess the Mystery Plant</h2>
          </div>
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {getLast7Days().map((date) => {
                  ...
                  return (
                    <Link
                      key={dateParam}
                      href={`/brainwave/botanle${isToday ? '' : `?date=${dateParam}`}`}
