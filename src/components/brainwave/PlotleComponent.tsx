      ...
      <div className="bg-gray-800/50 backdrop-blur-lg rounded-3xl border border-gray-700 p-5 mb-5">
        ...
        <div className="flex justify-between items-center mb-5">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-white">Guess the Mystery Movie</h2>
          </div>
                  ...
                  {revealPercentage === 0 && (
                    <div className="absolute inset-0 flex items-center justify-center z-30 bg-black/70">
                      <div className="text-center">
                        <div className="w-16 h-16 bg-pink-500/20 rounded-full flex items-center justify-center mx-auto mb-3 border-2 border-purple-500/50">
                          <span className="text-pink-400 text-2xl font-bold">?</span>
                        </div>
                        <p className="text-pink-400 font-semibold">Mystery Movie</p>
                      </div>
                    </div>
                  )}
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {getLast7Days().map((date) => {
                  ...
                  return (
                    <Link
                      key={dateParam}
                      href={`/brainwave/plotle${isToday ? '' : `?date=${dateParam}`}`}
