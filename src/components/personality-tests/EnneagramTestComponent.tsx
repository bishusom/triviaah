...
import { 
  ...
  EnneagramScores, 
  UserEnneagramAnswer 
} from '@/lib/personality-tests/enneagram/enneagram-types';
import { 
  enneagramQuestions,
  calculateEnneagramScores,
  getEnneagramResult
} from '@/lib/personality-tests/enneagram/enneagram-logic';
...
Share your results:
https://triviaah.com/brainwave/enneagram
...
Discover your Enneagram type at https://triviaah.com/brainwave/enneagram`;
  };
