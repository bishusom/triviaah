// src/components/home/DailyTriviaFacts.tsx - Updated with matching card styling
'use client';
...
export default function DailyTriviaFact() {
        ...
        <div className="flex flex-col sm:flex-row sm:items-start gap-4">
          <div className="flex items-center gap-3 flex-1">
            ...
            <div className="space-y-2 flex-1">
              ...
              <div className="bg-gray-200 rounded h-3 w-48 animate-pulse"></div>
            </div>
          </div>
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 w-full">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-gray-800 text-sm">Daily Trivia Fact</h3>
              <p className="text-gray-500 text-xs">Loading fact...</p>
            </div>
          </div>
        </div>
      </div>  
  ...
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-all duration-300 hover:border-blue-400 hover:-translate-y-1 p-6 w-full">
      ...
      <div className="block sm:hidden">
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-gray-800 text-lg">Daily Trivia Fact</h3>
        ...
        >
          ...
          {fact.fact_text.length > 120 && (
            <button 
              onClick={() => setIsExpanded(!isExpanded)}
              className="flex items-center gap-1 text-blue-600 hover:text-blue-700 text-xs mt-2 transition-colors"
            >
              {isExpanded ? (
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {fact.source && (
            <button
              ...
              className={`flex items-center gap-1 bg-gray-50 border border-gray-200 rounded-lg px-3 py-1 text-sm transition-all ${
                fact.source_url 
          ...
          {isCopied && (
            <div className="bg-green-100 border border-green-200 rounded-lg px-2 py-1">
              <span className="text-green-800 text-xs">Copied!</span>
            </div>
          )}
        </div>
      </div>
