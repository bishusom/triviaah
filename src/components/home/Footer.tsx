...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-gray-800 border-t border-gray-700 py-12 px-4" data-no-ads="true">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="w-10 h-10 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg flex items-center justify-center">
                <Image 
                  ...
                  width={20} 
                  height={20}
                  className="text-white" // You can adjust this if needed
                />
              </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/daily-challenge" className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 flex items-center gap-2 group">
