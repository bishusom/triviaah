  ...
  const brainTeasers = [
    {
      ...
      image: '/imgs/brainwave/plotle-160x160.webp',
    ...
    },
    {
      ...
      image: '/imgs/brainwave/capitale-160x160.webp',
    ...
    },
    {
      ...
      image: '/imgs/brainwave/celebrile-160x160.webp',
    ...
    },
    {
      ...
      image: '/imgs/brainwave/creaturedle-160x160.webp',
    ...
    },
    {
      ...
      image: '/imgs/brainwave/foodle-160x160.webp',
    ...
    },
    {
      ...
      image: '/imgs/brainwave/songle-160x160.webp',
    ...
    },
    {
      ...
      image: '/imgs/brainwave/historidle-160x160.webp',
              ...
              >
                ...
                <div className={`relative rounded-xl overflow-hidden border-2 transition-all duration-300 transform h-full ${
                  ...
                  <div className="relative p-3 sm:p-4 min-h-[80px] sm:min-h-[100px] flex flex-col justify-center">
                    ...
                    <div className="flex items-center justify-center text-white/90 text-xs drop-shadow-sm">
                      <span>{teaser.players} playing</span>
                    </div>
                  </div>
                </div>
              </Link>
