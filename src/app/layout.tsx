...
export const metadata: Metadata = {
  ...
  title: 'Elite Trivias: Free Daily Trivia & Quiz Games',
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/imgs/Elite Trivias-og.webp',
        width: 1200,
        height: 630,
        alt: 'Elite Trivias - Free Daily Trivia & Quiz Games'
      }
    ],
    type: 'website',
  },
  twitter: {
    ...
    title: 'Elite Trivias: Free Daily Trivia & Quiz Games',
    description: 'Play free daily trivia challenges across 20+ categories. New questions every 24 hours!',
    images: ['/imgs/Elite Trivias-og.webp'],
  },
};
