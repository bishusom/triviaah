...
export const metadata: Metadata = {
  ...
  description: 'Play free daily trivia, Brainwave puzzles, and weekly quiz challenges on Triviaah. Track scores, invite friends, and build a streak worth defending every week.',
