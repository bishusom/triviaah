...
export default function NumberScramblePage() {
  ...
  const [structuredData, setStructuredData] = useState({
    ...
    webpage: {
      '@context': 'https://schema.org',
      '@type': 'WebPage',
      name: 'Number Sequence Puzzle Game | Free Math Brain Teaser | Elite Trivias',
      ...
      mainEntity: {
        ...
        gameLocation: 'https://elitetrivias.com/number-puzzles/number-scramble',
    ...
    breadcrumb: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: 'Number Sequence',
          item: 'https://elitetrivias.com/number-puzzles/number-scramble'
        }
      ]
    },
    faq: {
