...
export default async function DailyQuizzesPage() {
  ...
  // Split puzzles into two rows for mobile (6 puzzles each)
  const firstRowPuzzles = dailyPuzzles.slice(0, 6);
  const secondRowPuzzles = dailyPuzzles.slice(6, 12);
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="lg:hidden mb-16">
          {/* First Row */}
          <div className="mb-6">
            <h3 className="text-xl font-bold text-white mb-4 ml-2">Popular Games</h3>
            <div className="relative">
              <div className="flex overflow-x-auto pb-6 -mx-4 px-4 snap-x snap-mandatory scrollbar-hide gap-4">
                {firstRowPuzzles.map((puzzle, index) => (
                  <div key={puzzle.category} className="flex-none w-[280px] snap-start">
          ...
          {/* Second Row */}
          <div>
            <h3 className="text-xl font-bold text-white mb-4 ml-2">More Games</h3>
            <div className="relative">
              <div className="flex overflow-x-auto pb-6 -mx-4 px-4 snap-x snap-mandatory scrollbar-hide gap-4">
                {secondRowPuzzles.map((puzzle, index) => (
                  <div key={puzzle.category} className="flex-none w-[280px] snap-start">
                    <PuzzleCard puzzle={puzzle} index={index + 6} />
                  </div>
                ))}
              </div>
            </div>
