...
export default function PlotlePage() {
        ...
        {isPastPuzzle && dateParam && (
          <div className="mt-2 inline-flex items-center gap-2 px-3 py-1 bg-amber-500/10 border border-amber-500/30 rounded-full">
            ...
            <span className="text-amber-400 text-xs font-semibold">
              Past puzzle – {new Date(dateParam).toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' })}
            </span>
          </div>
        )}
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col items-center gap-4 mt-6">
          ...
          <FeedbackComponent
            gameType="plotle"
            category="brainwave"
            metadata={{ attempts: attempts.length, won: gameState === 'won', correctAnswer: data.targetTitle }}
          />
  ...
  return (
    <div className="min-h-screen bg-[#050505] py-4">
      {/* Structured data */}
      <Script id="org-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(STRUCTURED_DATA.organization) }} />
      <Script id="page-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(STRUCTURED_DATA.webpage) }} />
      <Script id="faq-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(STRUCTURED_DATA.faq) }} />
